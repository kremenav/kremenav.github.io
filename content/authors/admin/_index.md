...
profiles:
  - icon: at-symbol
    url: 'mailto:kremena@parity.io'
    label: E-mail Me
  - icon: brands/github
    url: https://github.com/kremenav
  - icon: brands/linkedin
    url: https://ch.linkedin.com/in/kremena-valkanova-71222a1a2
...
<a href="/uploads/MajorityQuorumRules_slides.pdf" target="_blank" title="View Slides" class="inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 icon-accent transition-transform transform hover:scale-110 shadow-sm no-underline">
<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 13v-1m4 1v-3m4 3V8M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" /></svg>
</a>
...
<a href="#" 
  ...
  year={2024},
  journal      = {arXiv preprint arXiv:2410.22001},
  doi          = {10.48550/arXiv.2410.22001},
  eprint       = {2410.22001},
  archivePrefix= {arXiv},
...
<a href="#" 
  ...
  year={2024},
  journal      = {arXiv preprint arXiv:2410.20476},
  doi          = {10.48550/arXiv.2410.20476},
  eprint       = {2410.20476},
  archivePrefix= {arXiv},
  primaryClass = {econ.TH}
}">
...
<div class="mb-6 p-6 bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col w-full"><h4 class="text-xl font-bold text-gray-900 mt-0 mb-1 leading-none" style="margin-top: 0 !important;">Irrelevant Alternatives Bias Large Language Model Hiring Decisions</h4>
...
<div class="mb-6 p-6 bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col w-full"><h4 class="text-xl font-bold text-gray-900 mt-0 mb-1 leading-none" style="margin-top: 0 !important;">Fictitious Play in Networks</h4>
...
function copyBibtex(btn) {
  // 1. Get the BibTeX text from the data attribute
  const bibtex = btn.getAttribute('data-clipboard-text');
  
  // 2. Write to clipboard
  navigator.clipboard.writeText(bibtex).then(() => {
    
    // 3. Visual Feedback: Save the old icon
    const originalContent = btn.innerHTML;
    
    // 4. Show a Green Checkmark temporarily
    btn.innerHTML = `
    ...
    // 5. Revert back to original icon after 2 seconds
    setTimeout(() => {
